 ...
 * τις υπηρεσίες add, sub , mul.div κι mod
 * Eμφανίζει ένα menu προς τον χρήστη με επιλογές,
 * λαμβάνει την τιμή της επιλογής και στη συνέχεια δύο τιμές των
 * num1, num2. Τελικά εμφανίζει το αποτέλεσμα
 */
